...
frontend/
├── src/
│   ├── components/               # Chatbot, category, accessibility, service UI primitives
│   ├── data/                     # Static service/document fixtures for prototype
│   ├── layout/                   # App shell, header/footer, accessibility context
│   ├── pages/                    # Home (chatbot + navigation) and ServiceDetail templates
│   ├── styles/                   # Design tokens + global styles (sky-blue civic palette)
│   ├── types/                    # Service/document/support channel domain models
│   └── utils/                    # Search helpers mapping user queries to guidance content
