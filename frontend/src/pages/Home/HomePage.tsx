...
export const HomePage = () => {
  ...
  return (
    <div className={styles.page}>
      <section className={styles.hero}>
        <div>
          ...
          <h1 className={styles.heading}>
            민원 서류 준비, <span className={styles.highlight}>챗봇이 먼저 안내</span>해 드릴게요
          </h1>
          <p className={styles.description}>
            궁금한 민원을 입력하면 온라인과 오프라인 준비방법을 한 번에 알려드립니다. 누구나
            이해하기 쉬운 단계별 안내로 빠르게 준비하세요.
          </p>
      ...
      <section id="chatbot" className={styles.chatbotShell}>
        <h2>챗봇으로 바로 민원 안내 받기</h2>
        <p className={styles.helperText}>상황을 자유롭게 입력하면 단계별로 안내해 드립니다.</p>
        <ChatbotInput
          value={query}
          onChange={setQuery}
          onSubmit={(value) => {
      ...
      <section id="life-events" className={styles.categories}>
      ...
      <section id="accessibility" className={styles.accessibilityBanner}>
        <h2>누구나 편하게 이용할 수 있도록 준비 중입니다</h2>
        <p>
          글자 크기 조절, 고대비 모드, 음성 안내 등 접근성 도구를 곧 제공할 예정입니다. 계속해서
          의견을 들으며 개선해 나가겠습니다.
        </p>
